                    ...
                    <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                        ...
                        <div>
                            <div class="btn-wrapper">
                                {{-- <a href="{{ route('operation.create')}}" class="btn btn-primary text-white me-0"><i class="mdi mdi-plus-circle-outline"></i>Nouvelle Opération</a> --}}
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $operation->actif_account }}</td>
                                            <td>{{ $operation->passif_account }}</td>
