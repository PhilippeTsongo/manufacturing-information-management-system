                            ...
                            <div class="card card-rounded">
                              <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-start">
                                    <div>
                                        <h4 class="card-title card-title-dash">Enregistrez un Nouveau Compte</h4>
                                        <h5 class="card-subtitle card-subtitle-dash">Complétez ce formulaire pour Enregistrer une nouveau Compte</h5>
                                    ...
                                    <div class="row">
                                      <div class="col-lg 6">   
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="account_number" :value="old('account_number')" required autofocus  class="form-control" id="exampleInputUsername2" placeholder="Numéro de compte ">
                                        </div>
                                      </div>
                                      <div class="col-lg 6">   
                                          <div class="form-group">
                                              <label for="exampleInputUsername1">Intitulé du compte</label>
                                              <input type="text" name="account_name" :value="old('account_name')" required autofocus  class="form-control" id="exampleInputUsername1" placeholder="Intitulé du compte">
                                          </div>
                                      </div> 
                                    </div> 
                                    <div class="row">
