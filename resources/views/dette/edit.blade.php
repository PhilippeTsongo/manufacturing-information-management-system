                              ...
                              <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-start">
                                    <div>
                                        ...
                                        <h5 class="card-subtitle card-subtitle-dash">Complétez ce formulaire pour modifier une nouvelle Dette</h5>
                                      ...
                                      <div class="col-lg 4">   
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                              <input type="number" name="quantity" value="{{ old('quantity') ?? $dette->quantity }}" required autofocus  class="form-control" id="exampleInputUsername2" placeholder="quantité">
                                          </div>
                                        </div>
                                      </div>
                                      ...
                                      <div class="col-lg 4">   
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                              ...
                                              <input type="text" name="montant" value="{{ old('montant') ?? $dette->montant }}" required autofocus  class="form-control" id="exampleInputUsername6" placeholder="montant">
                                          </div>
                                        </div>
                                      </div>
                                    </div>
