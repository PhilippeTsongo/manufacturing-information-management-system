                            ...
                            <div class="card card-rounded">
                              <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-start">
                                    <div>
                                        <h4 class="card-title card-title-dash">Enregistrez un Nouveau Bureau</h4>
                                    ...
                                    <div class="row">
                                        <div class="col-lg 6">   
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" :value="old('name')" required autofocus  class="form-control" id="exampleInputUsername1" placeholder="nom du bureau">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg 6">   
                                          <div class="form-group">
                                              ...
                                              <input type="text" name="chef" :value="old('name')" required autofocus  class="form-control" id="exampleInputUsername2" placeholder="chef de bureau">
                                          </div>
                                        </div>
