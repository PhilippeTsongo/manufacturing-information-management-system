                            ...
                            <div class="card card-rounded">
                              <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-start">
                                    <div>
                                        <h4 class="card-title card-title-dash">{{ GoogleTranslate::trans('Enregistrez un Nouveau Bureau', $appLocale)}}</h4>
                                ...
                                <form class="forms-sample" method="POST" action="{{ route('office.store') }}">
                                    @csrf
                                    <div class="row">
                                        <div class="col-lg 6">   
                                            <div class="form-group">
                                                <label for="exampleInputUsername1">{{ GoogleTranslate::trans('Nom du Bureau', $appLocale)}}</label>
                                                <input type="text" name="name" :value="old('name')" required autofocus  class="form-control" id="exampleInputUsername1" placeholder="{{ GoogleTranslate::trans('nom du bureau', $appLocale)}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg 6">   
                                          <div class="form-group">
                                              ...
                                              <input type="text" name="chef" :value="old('name')" required autofocus  class="form-control" id="exampleInputUsername2" placeholder="{{ GoogleTranslate::trans('chef de bureau', $appLocale)}}">
                                          </div>
                                        </div>
