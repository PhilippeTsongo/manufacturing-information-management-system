              ...
              <div class="home-tab">
                ...
                <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                  <ul class="nav nav-tabs" role="tablist">
                      <li class="nav-item">
                          <a class="nav-link active ps-0" id="home-tab" data-bs-toggle="tab" href="#overview" role="tab" aria-controls="overview" aria-selected="true">Pièces Justificatives</a>
                      </li>
                  </ul>
                  <div>
                    <div class="btn-wrapper">
                      <a href="{{ route('justification.index')}}" class="btn btn-primary text-white me-0"><i class="mdi mdi-plus-circle-outline"></i>Liste de Pièces Justificatives</a>
                    </div>
                  </div>
              </div>
                          ...
                          <div class="col-12 col-lg-4 col-lg-12 grid-margin stretch-card">
                            <div class="card card-rounded">
                              <div class="card-body">
                                ...
                                <form class="forms-sample" method="POST" action="{{ route('justification.store') }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                      <div class="col-lg 12">   
