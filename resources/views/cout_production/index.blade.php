                              ...
                              <div class="btn-group">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuSplitButton1">
                                    @foreach($mois as $month)
                                        <a target="blank" href="{{ route('rapport.cout.production', ['month' => $month->name ]) }}" method="GET" class="dropdown-item">{{ $month->name }}</a>
                                    @endforeach                             
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="card">
                              <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-start">
                                    <div>
                                        <h4 class="card-title">{{ GoogleTranslate::trans('Liste de Couts de Productions Journalièrs', $appLocale)}} [{{ $today }}]</h4>
                                    </div>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $daily->production_number}}</td>
                                            <td>{{$daily->libelle}}</td>
                                            <td class="text-danger">{{  number_format($daily->montant, 02) .'$' }}</td>
                                            <td >{{ $daily->date_production }}</td>
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                              <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-start">
                                    <div>
                                        <h4 class="card-title">{{ GoogleTranslate::trans('Liste de Couts de Productions Mensuels', $appLocale)}} [{{ date('M') }}]</h4>
                                    </div>
                                    <div id="performance-line-legend"></div>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $month->production_number}}</td>
                                            <td>{{$month->libelle}}</td>
                                            <td class="text-danger">{{  number_format($month->montant, 02) .'$' }}</td>
                                            <td >{{ $month->date_production }}</td>
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                              <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-start">
                                    <div>
                                        <h4 class="card-title">{{ GoogleTranslate::trans('Liste de Couts de Productions Annuels', $appLocale)}} [{{ $year }}]</h4>
                                    </div>
                                    <div id="performance-line-legend"></div>
                                </div>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $year->production_number}}</td>
                                            <td>{{ $year->libelle}}</td>
                                            <td class="text-danger">{{  number_format($year->montant, 02) .'$' }}</td>
                                            <td >{{ $year->date_production }}</td>
