...
class GrandLivreRapportController extends Controller
{
    ...
    public function grand_livre_rapport(Request $request, $month)
    {
        ...
        if (isset($month)) {
            ...
            $this->address->cell('50', '5', "ACCOUNTING LEDGER OF THE MONTH " . strtoupper($month), '0', '1');
            ...
            $this->address->cell('50', '3', "", '0', '1');
            $this->address->cell('50', '9', utf8_decode("Purchase of raw materials"), '0', '1');
            $this->address->cell('50', '3', "", '0', '1');

            //TITLE
            $this->title->Cell('20', '7', utf8_decode('Account'), '1', '0', '', TRUE);
            $this->title->Cell('92', '7', utf8_decode('Debit'), '1', '0', '', TRUE);
            $this->title->Cell('25', '7', utf8_decode('Credit'), '1', '0', '', TRUE);
            $this->title->Cell('20', '7', utf8_decode('Account'), '1', '0', '', TRUE);
            $this->title->Cell('25', '7', utf8_decode('Debit'), '1', '0', '', TRUE);
            $this->title->Cell('92', '7', utf8_decode('Credit'), '1', '1', '', TRUE);
            ...
            $this->address->cell('50', '3', "", '0', '1');
            $this->address->cell('50', '9', utf8_decode("Purchase of Packaging"), '0', '1');
            $this->address->cell('50', '3', "", '0', '1');
